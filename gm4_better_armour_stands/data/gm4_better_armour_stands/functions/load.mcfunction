execute if score gm4 load matches 2 run scoreboard players set gm4_better_armour_stands load 2
execute unless score gm4 load matches 2 run data modify storage gm4:log queue append value {type:"missing",module:"Better Armour Stands",require:"Gamemode 4"}
