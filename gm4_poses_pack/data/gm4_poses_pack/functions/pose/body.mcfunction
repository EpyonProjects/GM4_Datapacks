...
#predefined poses
execute if data storage gm4_poses_pack:temp/book Item.tag{pages:["reset"]} run data merge entity @e[type=armor_stand,distance=..1,limit=1,sort=nearest,tag=!gm4_no_edit] {Pose:{Body:[-.1f,0f,0f]}}
