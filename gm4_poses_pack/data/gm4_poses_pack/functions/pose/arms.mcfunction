...
execute if data storage gm4_better_armour_stands:temp/book Item.tag{pages:["left"]} if entity @p[distance=..1] as @e[distance=..1,type=armor_stand,sort=nearest,tag=!gm4_no_edit] run function gm4_poses_pack:pose/player/arm_left
execute if data storage gm4_better_armour_stands:temp/book Item.tag{pages:["right"]} if entity @p[distance=..1] as @e[distance=..1,type=armor_stand,sort=nearest,tag=!gm4_no_edit] run function gm4_poses_pack:pose/player/arm_right

#if book contains a page with "mirror", mirror this pose to the other arm
execute if data storage gm4_better_armour_stands:temp/book Item.tag{pages:["mirror","left"]} as @e[distance=..1,type=armor_stand,sort=nearest,tag=!gm4_no_edit] run function gm4_poses_pack:pose/player/mirror_arm_left
execute if data storage gm4_better_armour_stands:temp/book Item.tag{pages:["mirror","right"]} as @e[distance=..1,type=armor_stand,sort=nearest,tag=!gm4_no_edit] run function gm4_poses_pack:pose/player/mirror_arm_right

#if book contains a page with "swap" or "flip"
execute if data storage gm4_better_armour_stands:temp/book Item.tag{pages:["swap"]} as @e[distance=..1,type=armor_stand,sort=nearest,tag=!gm4_no_edit] run function gm4_poses_pack:pose/player/swap_arms
execute if data storage gm4_better_armour_stands:temp/book Item.tag{pages:["flip"]} as @e[distance=..1,type=armor_stand,sort=nearest,tag=!gm4_no_edit] run function gm4_poses_pack:pose/player/flip_arms
